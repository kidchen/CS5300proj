...
public class RandomPageRankReduce extends MapReduceBase implements Reducer<Text, Text, Text, Text> {
	...
	public void reduce(Text key, Iterator<Text> values, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
        ...
        reporter.incrCounter(PRCounter.GLOBAL_RESIDUAL_COUNTER, amplifiedValue);
        reporter.incrCounter(PRCounter.LOCAL_ITERATION_NUM_COUNTER, numIter);
        reporter.incrCounter(PRCounter.BLOCK_COUNTER, 1);
    	...
    	reporter.incrCounter(BlockCounter.values()[currentBlock], amplifiedhighestNodePR);

//    	System.err.println("currentBlock " + currentBlock +
//				" highestNodeID " + highestNodeID + 
//				" highestNodePR " + highestNodePR + 
//				" amplifiedhighestNodePR " + amplifiedhighestNodePR);
    }
}
