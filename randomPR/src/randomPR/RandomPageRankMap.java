...
public class RandomPageRankMap extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text>{    
	public void map(LongWritable key, Text value, OutputCollector<Text, Text> output, Reporter reporter) throws IOException {
    	...
    	// "links" is the label denoting this is a node with its dstNodeIDList
		...
		// "PageRanks" is the label denoting this is a node with the old u_pr
